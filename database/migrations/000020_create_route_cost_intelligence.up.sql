...
ALTER TABLE trip_frictions ADD COLUMN IF NOT EXISTS opportunity_cost NUMERIC(14, 2) NOT NULL DEFAULT 0.00;
...
CREATE TABLE IF NOT EXISTS trip_contingency_funds (
...
CREATE INDEX IF NOT EXISTS idx_trip_contingency_funds_company_id ON trip_contingency_funds (company_id);
CREATE INDEX IF NOT EXISTS idx_trip_contingency_funds_status ON trip_contingency_funds (status);
